...
describe("C++", () => {
  it("compiles and runs c++", async () => {
    ...
    const data = JSON.parse(result.body);
     ...
     expect(data.verdict).toBe(",correct,correct,correct,correct,correct,correct,correct,correct,correct,correct");
    ...
    it("compiles and runs Java", async () => {
        ...
        const data = JSON.parse(result.body);
        // expect(data.submissionid).toBe("123");
        expect(data.verdict).toBe(",correct,correct,correct,correct,correct,correct,runtime_error,runtime_error,runtime_error,runtime_error,runtime_error,runtime_error,runtime_error,runtime_error,runtime_error");
        //  expect(data.stderr).toBe("");
        // expect(data.stdout).toBe("6\n");
        //  expect(data.memory).toMatch(/[0-9]{4}/);
        //   expect(data.time).toMatch(/\d\.\d\d/);
